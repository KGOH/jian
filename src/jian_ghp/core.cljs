...
и распложены симметрично. Это позволяет одной рукой нажать любую клавишу на верхнем или нижнем слое. На той же клавиатуре Plank приходится задействовать обе руки."]]
   ...
   [:section
    ...
    [:div.flex
     [:div
      [:p "Ниже на двух картинках собраны действия всех кнопок в раскладках ЙЦУКЕН и QWERTY. Вы можете сделать скриншот и подглядывать
в него в момент обучения раскладки Jian."]
   ...
   [:section
    ...
    [:p.l "В базовый комплект Jian входит: печатная плата, корпус, два контроллера Pro Micro и электронны компоненты (диоды, резисторы и т.п.). Вам нужно отдельно приобрести USB Micro, TRRS-TRRS–кабеля, свитчи и кейкапы. Светодиоды и ленту подсветки — опционально. А затем самостоятельно набор собрать."]
    [:p.l "💰Цена базового комплекта — около 5000 руб. или 80 долларов."]
    ...
    [:p.l "Заказать клавиатуру можно через Google-форму, а получить консультацию — через Telegram."]
    [:p.l "💰Оставить заявку на Jian — "[:a {:href "https://forms.gle/AcyEtRFcPVQzU2TM"} "https://forms.gle/AcyEtRFcPVQzU2TM"][:br]
     "👉Telegram-канал посвященный Jian — "[:a {:href "https://t.me/kgofhedgehogs"} "https://t.me/kgofhedgehogs"] [:br]
     "👉Мой личный Telegram — " [:a {:href "https://t.me/The2lb3oz4dr10grOfHedgehogs"} "https://t.me/The2lb3oz4dr10grOfHedgehogs"]]]]
