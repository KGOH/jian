...
на обычной клавиатуре."]]
   ...
   [:section
    [:div
     ...
     [:p.l "💰 Оставить заявку на Jian — "[:a {:href "https://forms.gle/AcyEtRFcPVQzU2TM"} "https://forms.gle/AcyEtRFcPVQzU2TM"] [:br] "👉 Telegram-канал посвященный Jian — "[:a {:href "https://t.me/kgofhedgehogs"} "https://t.me/kgofhedgehogs"] [:br]
