...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__1048){
var map__1049 = p__1048;
var map__1049__$1 = (((((!((map__1049 == null))))?(((((map__1049.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1049.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1049):map__1049);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1049__$1,cljs.core.cst$kw$on_DASH_write);
...
(jsprops.onChange = (function (p1__1051_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__1051_SHARP_);
}));
