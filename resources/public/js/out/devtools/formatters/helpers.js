...
var G__25079 = devtools.prefs.pref.call(null,v);
v = G__25079;
continue;
} else {
return v;
...
}catch (e25082){var _e__24220__auto__ = e25082;
return false;
}})();
...
}catch (e25086){var _e__24220__auto__ = e25086;
return false;
}})();
...
}catch (e25088){var _e__24220__auto__ = e25088;
return false;
}}
}
});
...
var vec__25090 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
...
return cljs.core.some.call(null,(function (p1__25093_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25093_SHARP_);
}),template);
});
