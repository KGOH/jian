...
var file = cljs.core.get.call(null,map__29829__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__29829__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__29829__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e29828){var _e = e29828;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___29831 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___29831)){
var seen_errors_29832 = temp__5733__auto___29831;
if(cljs.core.truth_(seen_errors_29832.has(self))){
} else {
seen_errors_29832.add(self);

var temp__5735__auto___29833 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___29833)){
var sense_29834 = temp__5735__auto___29833;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29834)].join(''));
} else {
}
}
} else {
