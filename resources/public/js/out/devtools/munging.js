...
var o24958 = temp__5733__auto__;
var temp__5733__auto____$1 = (o24958["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o24959 = temp__5733__auto____$1;
return (o24959["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24213__auto__ = f;
return (o__24213__auto__["toString"]).call(o__24213__auto__);
} else {
return "";
}
}catch (e24960){var _ = e24960;
return "";
}});
...
try{var o__24213__auto___24962 = t;
(o__24213__auto___24962["cljs$lang$ctorPrWriter"]).call(o__24213__auto___24962,t,writer);
}catch (e24961){var __24963 = e24961;
}
...
var char_code = (function (){var o__24213__auto__ = (new String(char$));
return (o__24213__auto__["charCodeAt"]).call(o__24213__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24213__auto__ = String;
return (o__24213__auto__["fromCharCode"]).call(o__24213__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24964 = num_code;
switch (G__24964) {
case (1):
return (185);
...
var o__24213__auto__ = String;
return (o__24213__auto__["fromCharCode"]).call(o__24213__auto__,superscript_code);
});
/**
...
}catch (e24966){var _e__24220__auto__ = e24966;
return false;
}})())){
...
var vec__24967 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24967,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24972){
var vec__24973 = p__24972;
var ns_detector = cljs.core.nth.call(null,vec__24973,(0),null);
...
var G__24979 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24980 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24979;
remaining_tokens = G__24980;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24970){
var G__24971 = cljs.core.first.call(null,seq24970);
var seq24970__$1 = cljs.core.next.call(null,seq24970);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24971,seq24970__$1);
}));
...
var vec__24984 = cljs.core.split_with.call(null,(function (p1__24983_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24983_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24984,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24984,(1),null);
...
var vec__24990 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24990,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24990,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24993 = cljs.core.rest.call(null,remaining_tokens);
var G__24994 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24993;
name_tokens = G__24994;
continue;
} else {
...
var vec__24997 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24997,(0),null);
var arity = cljs.core.nth.call(null,vec__24997,(1),null);
var vec__25000 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25000,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25000,(1),null);
var vec__25003 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25003,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25003,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25003,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25003,(3),null);
...
var vec__25009 = result;
var munged_ns = cljs.core.nth.call(null,vec__25009,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25009,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25009,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25009,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25009,(4),null);
var arity = cljs.core.nth.call(null,vec__25009,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__25013 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__25013,(0),null);
var args = cljs.core.nth.call(null,vec__25013,(1),null);
var vec__25016 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25016,(0),null);
var name = cljs.core.nth.call(null,vec__25016,(1),null);
...
var G__25019 = (arity + (1));
var G__25020 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25021){
var vec__25022 = p__25021;
var arity = cljs.core.nth.call(null,vec__25022,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25022,(1),null);
...
return cljs.core.get.call(null,arities,p1__25025_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__25026_SHARP_){
return cljs.core.drop.call(null,(2),p1__25026_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25029){
var vec__25030 = p__25029;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25030,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25027){
var G__25028 = cljs.core.first.call(null,seq25027);
var seq25027__$1 = cljs.core.next.call(null,seq25027);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25028,seq25027__$1);
}));
...
var map__25038 = options;
var map__25038__$1 = (((((!((map__25038 == null))))?(((((map__25038.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25038.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25038):map__25038);
var include_ns_QMARK_ = cljs.core.get.call(null,map__25038__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25038__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25038__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25038__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25039 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25039,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25039,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25039,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25039,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25039,(4),null);
var arity = cljs.core.nth.call(null,vec__25039,(5),null);
...
var o__24213__auto__ = f;
return (o__24213__auto__["getBasis"]).call(o__24213__auto__);
});
/**
...
}catch (e25043){var _e__24220__auto__ = e25043;
...
var G__25044 = (obj[cljs.core.first.call(null,path)]);
var G__25045 = cljs.core.rest.call(null,path);
obj = G__25044;
path = G__25045;
continue;
} else {
...
var _STAR_ = (function (accum,p__25046){
var vec__25047 = p__25046;
var bit = cljs.core.nth.call(null,vec__25047,(0),null);
var protocol = cljs.core.nth.call(null,vec__25047,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25050){
var vec__25051 = p__25050;
var ns = cljs.core.nth.call(null,vec__25051,(0),null);
var name = cljs.core.nth.call(null,vec__25051,(1),null);
var selector = cljs.core.nth.call(null,vec__25051,(2),null);
...
var post_process = (function (p__25055){
var vec__25056 = p__25055;
var munged_name = cljs.core.nth.call(null,vec__25056,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25056,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25054_SHARP_){
return (obj[cljs.core.first.call(null,p1__25054_SHARP_)]);
}),sorted_matches);
