...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__23773){
...
var on_write = cljs.core.get.call(null,map__23774__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__23776_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__23776_SHARP_);
}));
