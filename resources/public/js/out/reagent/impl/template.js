...
var G__23822 = o;
goog.object.set(G__23822,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__23826 = o;
goog.object.set(G__23826,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__23827__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__23828__i < G__23828__a.length) {G__23828__a[G__23828__i] = arguments[G__23828__i + 0]; ++G__23828__i;}
  args = new cljs.core.IndexedSeq(G__23828__a,0,null);
} 
return G__23827__delegate.call(this,args);};
...
return G__23827__delegate(args);
});
...
var G__23830 = props;
var G__23830__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__23830,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23830);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__23830__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__23831 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__23831,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__23831;
}
})(),id_class);
...
var G__23832 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23832) {
case (0):
...
var vec__23834 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23834,(0),null);
var id = cljs.core.nth.call(null,vec__23834,(1),null);
var className = cljs.core.nth.call(null,vec__23834,(2),null);
...
var temp__5739__auto___23837 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___23837 == null)){
} else {
var key_23838 = temp__5739__auto___23837;
(jsprops.key = key_23838);
}
...
var temp__5739__auto___23839 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___23839 == null)){
} else {
var key_23840 = temp__5739__auto___23839;
(jsprops.key = key_23840);
}
...
var temp__5739__auto___23841 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___23841 == null)){
} else {
var key_23842 = temp__5739__auto___23841;
(jsprops.key = key_23842);
}
...
var temp__5739__auto___23843 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___23843 == null)){
} else {
var key_23844 = temp__5739__auto___23843;
(jsprops.key = key_23844);
}
...
var temp__5739__auto___23845 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___23845 == null)){
} else {
var key_23846 = temp__5739__auto___23845;
(jsprops.key = key_23846);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__23847_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__23847_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23848 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__23848,(0),null);
var derefed = cljs.core.nth.call(null,vec__23848,(1),null);
...
break;
default:
var G__23853 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__23854 = compiler;
v = G__23853;
compiler = G__23854;
continue;
...
var G__23855 = tag;
var G__23855__$1 = (((G__23855 instanceof cljs.core.Keyword))?G__23855.fqn:null);
switch (G__23855__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template23858 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template23858 = (function (opts,id,fn_to_element,meta23859){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta23859 = meta23859;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template23858.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23860,meta23859__$1){
var self__ = this;
var _23860__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23858(self__.opts,self__.id,self__.fn_to_element,meta23859__$1));
}));

(reagent.impl.template.t_reagent$impl$template23858.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23860){
var self__ = this;
var _23860__$1 = this;
return self__.meta23859;
}));

(reagent.impl.template.t_reagent$impl$template23858.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23858.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23858.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23858.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23858.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta23859","meta23859",1275258446,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23858.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23858.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23858");

(reagent.impl.template.t_reagent$impl$template23858.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template23858");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23858.
 */
reagent.impl.template.__GT_t_reagent$impl$template23858 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template23858(opts__$1,id__$1,fn_to_element__$1,meta23859){
return (new reagent.impl.template.t_reagent$impl$template23858(opts__$1,id__$1,fn_to_element__$1,meta23859));
});

}

return (new reagent.impl.template.t_reagent$impl$template23858(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
